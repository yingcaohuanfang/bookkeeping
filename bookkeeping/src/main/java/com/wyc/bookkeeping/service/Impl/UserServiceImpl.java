...
import com.wyc.bookkeeping.entity.DTO.UserDTO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public void updateNickname(String nicknameDTO) {
        User user = jwtUtil.getCurrentUser();
        user.setNickname(nicknameDTO);
    ...
    @Override
    public Object getBills(Long id) {
        return billsMapper.selectByIds(id);
    }

    @Override
    public Object getBillsThree(Long id) {
